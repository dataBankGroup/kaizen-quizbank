...
import { Question, Cloudinary, QuestionValues } from "../../utils/Type";
...
interface CreateProps {
  addQuestionState: (question: Question) => void;
}

const Create: React.FC<CreateProps> = ({ addQuestionState }) => {
  ...
  return (
    <>
      <Button
        variant="contained"
        className="flex space-x-4 min-w-[88px] h-[40px] font-bold bg-neutral-700 hover:bg-neutral-600 capitalize"
        onClick={handleOpen}
      >
        Add Question
      </Button>
